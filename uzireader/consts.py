...
UZI_ROLE_HEALTHCARE_PSYCHOLOGIST = "25."  # Reference page 89
UZI_ROLE_PSYCHOTHERAPIST = "16."  # Reference page 89
UZI_ROLE_DENTIST = "02."  # Reference page 89
UZI_ROLE_MIDWIFE = "03."  # Reference page 89
UZI_ROLE_NURSE = "30."  # Reference page 89
